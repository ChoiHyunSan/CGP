...
bool BumpMapShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
								...
								XMFLOAT4 diffuseColor)
{
	...
	RenderShader(deviceContext, instanceCount, instanceCount);
...
void BumpMapShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount)
{
